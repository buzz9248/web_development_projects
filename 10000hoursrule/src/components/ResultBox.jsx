    ...
    <>
      ...
      {resultVisible && (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', lineHeight: 1.5, mb: 8, }}>
          <Typography sx={{ fontSize: 20 }}>당신은 <span style={{ fontSize: 70 }}>
            {field}</span> 전문가가 되기 위해서</Typography>
          <Typography sx={{ fontSize: 20 }}>대략 <span style={{ fontSize: 70 }}>
            {calculatedDays}</span>일 이상 훈련하셔야 합니다!! 😳</Typography>
